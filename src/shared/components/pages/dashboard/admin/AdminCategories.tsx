...
import { Search, Plus, Edit3, Trash2, FolderTree, Briefcase } from "lucide-react";

export default function AdminCategories() {
    const [categories] = useState([
        { id: 1, name: "Technology", jobCount: 450, color: "bg-blue-100 text-blue-600" },
        { id: 2, name: "Healthcare", jobCount: 220, color: "bg-green-100 text-green-600" },
        { id: 3, name: "Finance", jobCount: 180, color: "bg-purple-100 text-purple-600" },
        { id: 4, name: "Education", jobCount: 130, color: "bg-amber-100 text-amber-600" },
        { id: 5, name: "Marketing", jobCount: 95, color: "bg-rose-100 text-rose-600" },
    ]);
    ...
    return (
        <DashboardLayout>
            <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 mb-2">Job Categories</h1>
                    <p className="text-gray-500 text-sm">Organize and manage job sectors on the platform.</p>
                </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50/50 border-b border-gray-100">
                                ...
                                <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Associated Jobs</th>
                                ...
                                <tr key={cat.id} className="hover:bg-gray-50/50 transition-colors group">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <p className="font-bold text-gray-900 group-hover:text-[#00b4d8] transition-colors">{cat.name}</p>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
