    ...
    return (
        <DashboardLayout>
            <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm">Manage your account preferences and security settings.</p>
            </div>
                    ...
                    {activeTab === "notifications" && (
                        <div className="p-8">
                            ...
                            <div className="space-y-4">
                                {[
                                    { title: "Job Alerts", desc: "Get notified about new jobs that match your skills." },
                                    { title: "Application Updates", desc: "Get notified when a company views or updates your application." },
                                    { title: "Newsletter", desc: "Receive weekly updates about career growth and market trends." },
                                    { title: "Security Alerts", desc: "Get notified about suspicious login attempts and account changes." }
                                ].map((item, i) => (
