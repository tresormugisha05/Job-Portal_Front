          ...
          <div className="lg:w-3/4">
            <div className="bg-white rounded-lg shadow mb-6 p-4">
              <div className="flex flex-col sm:flex-row justify-between items-center">
                <p className="text-gray-600 mb-2 sm:mb-0">Showing 1-10 of 3,000+ jobs</p>
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4, 5].map((job) => (
                <div key={job} className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2 mb-3">
                            <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded">Media</span>
                            <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded">Medical</span>
                            <span className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded">Restaurants</span>
                          </div>
                          <p className="text-gray-600 text-sm line-clamp-2">
                            Looking for an experienced health and food specialist to join our growing team...
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="mt-8 flex justify-center">
              <nav className="flex items-center gap-2">
                ...
                <button className="px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50">300</button>
