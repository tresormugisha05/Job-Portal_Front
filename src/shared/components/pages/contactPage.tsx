  ...
  return (
    <PageWrapper>
      <div className="min-h-screen bg-white overflow-x-hidden">
        {/* Hero Section */}
        <section className="relative bg-linear-to-br from-slate-900 via-slate-800 to-teal-900 overflow-hidden">
          {/* Pattern Background */}
          <div
          ...
          <div className="max-w-7xl mx-auto px-5 py-24 md:py-32 relative z-10">
            {/* Breadcrumb */}
            <nav
              className={`flex items-center gap-2.5 text-sm text-white/70 mb-5 transition-all duration-700 ${
                isAnimated
            ...
            {/* Title */}
            <h1
              className={`font-serif text-5xl md:text-7xl font-bold text-white m-0 tracking-tight transition-all duration-700 delay-200 ${
                isAnimated
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
