                    ...
                    <div className="flex-1">
                        <div className="flex items-start gap-5">
                            ...
                            <div className="w-16 h-16 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center border border-gray-300 shrink-0 shadow-sm">
                                <span className="text-xl font-bold text-gray-600">{candidate.initials}</span>
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex flex-wrap gap-y-2 gap-x-4 text-sm text-gray-500 mb-4">
                                    ...
                                    <span className="flex items-center gap-1.5">
                                        <Briefcase className="w-4 h-4 text-gray-400" /> {candidate.experience}
                                    </span>
                                    <span className="flex items-center gap-1.5">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {candidate.skills.slice(0, 5).map((skill, index) => (
                                        <span
                                            key={index}
                                            className={`px-2.5 py-1 text-xs font-medium rounded-full ${skillColors[index % skillColors.length]
                                                }`}
                                        >
                                            {skill}
                                        </span>
