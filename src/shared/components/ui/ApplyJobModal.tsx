      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
        <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl relative">
          ...
          <p className="text-gray-600 mb-8">
            ...
            <span className="font-bold text-[#00b4d8]">{jobTitle}</span> has
            been sent successfully. Good luck!
          </p>
          <button
            onClick={onClose}
      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl relative animate-scale-in my-8">
        ...
        <div className="p-8 text-center">
          <p className="text-gray-500 mb-8">
            Apply for the{" "}
            <span className="text-[#00b4d8] font-bold">{jobTitle}</span>{" "}
            position at{" "}
            <span className="text-[#00b4d8] font-bold">{companyName}</span>.
          </p>
          ...
          {!isCandidate ? (
            <div className="bg-orange-50 border border-orange-100 p-8 rounded-xl text-center">
              ...
              <p className="text-gray-600 mb-6">
                ...
                <span className="font-bold">Candidate</span> to apply for this
                job.
              </p>
              <Link
                to="/login"
              ...
              {!isAuthenticated && (
                <p className="mt-4 text-xs text-gray-400 italic">
                  No account? Select the Candidate role on the login page.
                </p>
              )}
              {isAuthenticated && (
                <p className="mt-4 text-xs text-red-400 font-medium">
                  Your current role ({role}) does not have permission to apply.
                </p>
              )}
            </div>
          ) : (
