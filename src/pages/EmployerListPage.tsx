  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const employersWithJobCount = employersData.map((employer: any) => ({
          ...employer,
          jobCount: jobsData.filter((job: any) => {
            const jobEmployerId =
              typeof job.employerId === "object" && job.employerId !== null
                      ...
                      <ul className="space-y-4">
                        {companyGroups[letter].map((company) => (
                          ...
                          >
                            ...
                            <Link
                              to={`/employers/${company._id || company.id}`}
