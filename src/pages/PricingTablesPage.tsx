      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            core features with different levels of job postings and visibility.
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-blue-600 rounded-lg p-8 max-w-4xl mx-auto">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            We offer enterprise solutions with custom features, dedicated
            support, and volume pricing. Contact our sales team to learn more.
          </p>
