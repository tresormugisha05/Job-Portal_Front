      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            You have {applicants.length} candidates who applied for your jobs.
          </p>
        </div>
                ...
                applicants.map((cand) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600">
                      {cand.submissionDate
                        ? new Date(cand.submissionDate).toLocaleDateString()
                        : "N/A"}
                    </td>
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase border ${getStatusStyle(cand.status)}`}
                      >
                        {cand.status}
                      </span>
                    </td>
