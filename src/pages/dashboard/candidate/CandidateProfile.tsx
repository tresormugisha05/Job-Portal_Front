                ...
                <div className="p-6">
                  <div className="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-bold text-gray-700 flex items-center gap-2">
                          <Briefcase className="w-4 h-4 text-[#00b4d8]" /> Title
                        </label>
                        <input
                          type="text"
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-4 py-2 bg-white border border-gray-200 rounded-lg col-span-2"
                        />
                      </div>
                    </div>
                  ))}
          ...
          <div className="max-w-4xl mx-auto flex justify-between items-center gap-4">
            ...
            <div className="flex gap-4 w-full md:w-auto">
              <button
                ...
                className="flex-1 md:flex-none px-8 py-3 bg-white text-gray-600 font-bold rounded-xl border border-gray-200 hover:bg-gray-50 transition-all"
              >
                Cancel
              </button>
              <button
                ...
                form="profile-form"
                disabled={isSaving}
                className="flex-1 md:flex-none px-8 py-3 bg-[#00b4d8] text-white font-bold rounded-xl hover:bg-[#0077b6] active:scale-95 transition-all flex items-center justify-center gap-2"
              >
                {isSaving ? (
