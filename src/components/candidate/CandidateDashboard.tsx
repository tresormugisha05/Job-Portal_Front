...
import type { ActivityItem } from "./RecentActivityList";

export default function CandidateDashboard() {
    const stats = [
        { label: "Applied Jobs", value: 12, icon: <Briefcase className="w-6 h-6" />, color: "bg-blue-500" },
        { label: "Saved Jobs", value: 8, icon: <Heart className="w-6 h-6" />, color: "bg-red-500" },
        { label: "Job Alerts", value: 5, icon: <Bell className="w-6 h-6" />, color: "bg-yellow-500" },
        { label: "Shortlisted", value: 3, icon: <CheckCircle className="w-6 h-6" />, color: "bg-green-500" },
    ];
    ...
    return (
        <DashboardLayout>
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome back, Jhon!</h1>
